...
public:
    ...
    const float* GetBaseColorFactor(uint32_t node_index, uint32_t primitive_index);
    ...
    void GetDebugBaseColorFactor(uint32_t node_index, uint32_t primitive_index, float** out_base_color_factor);
    void GetDebugEmissiveFactor(uint32_t node_index, uint32_t primitive_index, float** out_emissive_factor);
    void GetDebugMetallicFactor(uint32_t node_index, uint32_t primitive_index, float** out_metallic);
    void GetDebugRoughnessFactor(uint32_t node_index, uint32_t primitive_index, float** out_roughness);
